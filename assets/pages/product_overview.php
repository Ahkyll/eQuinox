...
<head>
    ...
    <title>eQuinox - Product Overview</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Price: <?php echo '₱' . number_format($product['price'], 2); ?></h5>
                        <!-- Modify the button to be an anchor tag -->
                        <a href="#" class="btn btn-primary btn-block custom-btn" id="buyNowButton" data-product-id="<?php echo $product['product_id']; ?>">Add to Cart</a>
                        <a href="#" class="btn btn-primary btn-block custom-btn" id="buyNowButton" data-product-id="<?php echo $product['product_id']; ?>">Add to Favorites</a>
                    </div>
                </div>
            </div>
        </div>
