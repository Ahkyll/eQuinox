            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-6 text-center">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link large-font main" href="products.php">Products</a></li>
        ...
        <div id="slideshow" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../images/2.png" class="d-block w-100" alt="First Slide">
                </div>
                <div class="carousel-item">
                    <img src="../images/3.png" class="d-block w-100" alt="Second Slide">
                </div>
                <div class="carousel-item">
                    <img src="../images/1.png" class="d-block w-100" alt="Third Slide">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="col-md-12 text-center">
          <form class="form-inline justify-content-center">
            ...
            <div class="input-group mt-3 mt-md-0">
              <select class="custom-select" id="categorySelect" onchange="filterByCategory()">
            ...
            <!-- Price Range Filter -->
            <div class="input-group mt-3 mt-md-0">
              <button class="btn btn-primary custom-btn" type="button" data-toggle="modal" data-target="#priceRangeModal">
                Price Range
              </button>
            </div>
  ...
  <section class="py-5 custom-bg2">
    <div class="container">
        ...
        <div class="row">
            ...
            // Fetch products that are not on sale
            $query = "SELECT * FROM products WHERE product_id NOT IN (SELECT product_id FROM sales)";
            $result = $conn->query($query);

            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo '<div class="col-md-3 mb-4 product-item text-center" data-category="' . $row['category_id'] . '" data-price="' . $row['price'] . '">';
                    echo '  <div class="product-item">';
                    echo '    <img src="' . $row['image'] . '" alt="' . $row['product_name'] . '" style="max-width: 100%; height: auto;">';
                    echo '    <h3><a href="product_overview.php?id=' . $row['product_id'] . '">' . $row['product_name'] . '</a></h3>';
